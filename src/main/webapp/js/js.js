...
$(function() {
    ...
    $('#add-inventory-link').click(function(e) {
        $("#add-inventory").delay(100).fadeIn(100);
        $("#add-product").fadeOut(100);
        $("#add-category").fadeOut(100);
        $("#update-product").fadeOut(100);
        $("#update-category").fadeOut(100);
    ...
    $('#update-inventory-link').click(function(e) {
        $("#update-inventory").delay(100).fadeIn(100);
        $("#add-product").fadeOut(100);
        $("#update-product").fadeOut(100);
        $("#add-category").fadeOut(100);
        $("#update-category").fadeOut(100);
